...
Java_com_madest_pad_rfid_SerialTask_SerialPortClose(JNIEnv *env, jobject instance,jint fd)
{
    close(fd);
}
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_madest_pad_rfid_SerialTask_SerialPortOpen(JNIEnv *env, jobject instance)
{
    // TODO
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_madest_pad_rfid_SerialTask_RecvSeralPort(JNIEnv *env, jobject instance,jint fd,jbyteArray buf) {
